    ...
    <div id='home' className='h-screen w-full bg-gradient-to-b from-black to-gray-500'>
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            <div className='flex flex-col items-stretch justify-center h-full w-full'>
                <h2 className='text-4xl sm:text-8xl font-bold text-white text-center'>Hello, I'm Min! </h2>
                <p className='text-lg sm:text-xl text-gray-600 py-2 text-center'>Welcome to Min's Website </p>
            </div>
